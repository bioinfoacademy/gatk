            ...
            // Frameshifts are all the same:
                ...
                if ( isInsertion ) {
                    if ( indelIsBetweenCodons ) {
                        ...
                        final String nextRefCodon = getNextReferenceCodon(
                        ...
                        // For - strand we get both the codon before and after the insertion:
                            ...
                            return "c.(" + alignedCodonStart + "-" +
                                    alignedCodonEnd + ")" +
                                    nextRefCodon.toLowerCase() + refCodon.toLowerCase() + ">" + nextRefCodon.toLowerCase() + altCodon.toUpperCase() + refCodon.toLowerCase();
                        }
                    }
                    else {
...
//            );
    ...
    public static ProteinChangeInfo createProteinChangeInfo(final Allele refAllele,
        ...
        final String referenceProteinSequence = FuncotatorUtils.createAminoAcidSequence(codingSequence, false);
