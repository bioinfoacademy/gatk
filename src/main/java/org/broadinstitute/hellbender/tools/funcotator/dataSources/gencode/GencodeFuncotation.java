...
public class GencodeFuncotation implements Funcotation {
    ...
    public String serializeToVcfString() {
        ...
        final List<String> funcotations = Arrays.asList((hugoSymbolSerializedOverride != null ? hugoSymbolSerializedOverride : (hugoSymbol == null) ? "Unknown" : hugoSymbol.isEmpty() ? "Unknown" : hugoSymbol),
