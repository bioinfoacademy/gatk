...
public class GencodeFuncotation implements Funcotation {
    ...
    public String serializeToVcfString() {
        ...
        final List<String> funcotations = Arrays.asList((hugoSymbolSerializedOverride != null ? hugoSymbolSerializedOverride : ((hugoSymbol != null) || hugoSymbol.isEmpty() ? hugoSymbol : "Unknown")),
